...
class BaseService(AbstractBaseService):
    ...
    @classmethod
    async def create(cls, data: BaseModel, session: SessionDep):
    ...
    @classmethod
    async def get(cls, obj_id: int, session: SessionDep):
    ...
    @classmethod
    async def edit(cls, obj_id: int, data: BaseModel, session: SessionDep):
    ...
    @classmethod
    async def delete(cls, obj_id: int, session: SessionDep):
...
class DependableBaseService(AbstractBaseService):
    ...
    @classmethod
    async def create(cls, data: BaseModel, dep, session: SessionDep):
        data = data.model_dump()
    ...
    @classmethod
    async def get(cls, obj_id: int, dep, session: SessionDep):
    ...
    @classmethod
    async def get_many(cls, pagination: PaginationDep, dep, session: SessionDep):
    ...
    @classmethod
    async def edit(cls, obj_id: int, data: BaseModel, dep, session: SessionDep):
        update = cls.repository.update(
            obj_id,
            data.model_dump(exclude_unset=True),
    ...
    @classmethod
    async def delete(cls, obj_id: int, dep, session: SessionDep):
